...
###### Gmail settings for error reporting ######
# Must add email/name to Admins
...
DATABASES = {
    'default': dj_database_url.config(default='postgres://POSTGRES_USER_NAME@localhost/POSTGRES_DATABASE_NAME')
}
...
SECRET_KEY = 'j8-)_w=&^fgcu%&#rla$*%t9(stq##mi!oc6=vkv9%2jusx9+9'
