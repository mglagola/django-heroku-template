...
def create_local_database(project_name):
	database_name = get_input('What should your database name be for local testing? ')
...
def s3_setup(project_name):
	...
	S3_BUCKET_NAME = get_input('S3 BUCKET NAME: ')
	venv_name = get_input('What is the name of your virtualenv dir? (i.e. ".env"): ')
...
def main():
	...
	project_name = get_input('What would you like to name your project? ')
